...
for(i in 1:numValid){
  ...
  # Fit the SARIMA(0,1,0)(1,1,0)[7] model
...
The training error is 0.64%. The testing error is 2.16%. 
...
The training error is 0.67%. The testing error is 2.19%. 
...
The training error is 0.61%. The testing error is 2.24%. 
...
The training error is 0.62%. The testing error is 2.28%. 
...
Forecast the covid-period using the model (1) SARIMA(0,1,1)(0,1,1)[7]. 
...
## Plot
autoplot(price.ts)+
  autolayer(covid_arima_forecast, series = "Forecasted Aug. Price", level = 0)
```
